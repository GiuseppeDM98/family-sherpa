...
- **Reminders** ✅ *working* — web push (installable PWA) and Telegram notifications as deadlines approach (30/7/1/0 days) and when a medicine dose is due. Enable push per device from Settings; Telegram reminders arrive automatically once linked.
