...
/**
 * Shared shapes for the deadline row/form/mark-paid trio, reused by both
 * `/deadlines` and the asset detail timeline. Kept apart from the components
 * themselves so the three files can reference each other's props without a
 * circular import.
 */
